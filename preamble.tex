...
% ------------------------------ Tabeller ------------------------------
% Øk høyde og bredde på tabellceller globalt
\renewcommand{\arraystretch}{1.3}  % Øker vertikal luft (standard = 1.0)
\setlength{\tabcolsep}{10pt}       % Øker horisontal luft (standard = ca 6pt)

% Gjør standard tabeller penere (valgfritt)
\setlength{\abovecaptionskip}{5pt}   % Avstand mellom tabell og tittel
\setlength{\belowcaptionskip}{5pt}   % Avstand etter tabell

% Eksempel på ny kolonne-type for bedre tekstbryting (valgfritt)
\newcolumntype{P}[1]{>{\raggedright\arraybackslash}p{#1}} % p-kolonne med venstrejustering